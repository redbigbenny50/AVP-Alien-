...
/**
 * The inventory/hand model for the resin_container.
 * <p>
 ...
 * </p>
 */
public class ResinContainerItemRenderer extends AzItemRenderer {

    private static final ResourceLocation MODEL = AlienResources.location("geo/block/resin_container.geo.json");

    private static final ResourceLocation TEXTURE = AlienResources.location("textures/block/resin_container.png");

    public ResinContainerItemRenderer() {
        super(
