...
/**
 * The inventory/hand model for the aberrant_resin_container.
 * <p>
 ...
 * </p>
 */
public class AberrantResinContainerItemRenderer extends AzItemRenderer {

    private static final ResourceLocation MODEL = AlienResources.location("geo/block/resin_container.geo.json");

    private static final ResourceLocation TEXTURE = AlienResources.location("textures/block/aberrant_resin_container.png");

    public AberrantResinContainerItemRenderer() {
        super(
