 ...
 * the {@code display} block in {@code models/item/tracker.json} is the raw Blockbench export and behaves exactly as
 * previewed.
 * <p>
...
public class TrackerItemRenderer extends AzItemRenderer {
    ...
    private static final ResourceLocation MODEL = AlienResources.location("geo/item/tracker.geo.json");

    private static final ResourceLocation TEXTURE = AlienResources.location("textures/item/tracker.png");
