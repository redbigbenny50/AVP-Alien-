...
/**
 * The inventory/hand model for the nether_resin_container.
 * <p>
 ...
 * </p>
 */
public class NetherResinContainerItemRenderer extends AzItemRenderer {

    private static final ResourceLocation MODEL = AlienResources.location("geo/block/resin_container.geo.json");

    private static final ResourceLocation TEXTURE = AlienResources.location("textures/block/nether_resin_container.png");

    public NetherResinContainerItemRenderer() {
        super(
