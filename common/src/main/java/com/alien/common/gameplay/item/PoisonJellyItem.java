 ...
 * {@code AlienPotions}). The old direct right-click-a-xeno interaction is deliberately gone - suppressing a xenomorph's
 * growth now requires the potion, mirroring how royal jelly requires the Metamorphosis potion.
 */
