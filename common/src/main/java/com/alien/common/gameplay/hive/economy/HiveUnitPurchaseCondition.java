...
public sealed interface HiveUnitPurchaseCondition {
     ...
     * harbinger - which is what makes empress-backed hives able to keep raiding after you have decapitated one. That
     * is the whole point: empress backing does not just share resources, it buys raid RESILIENCE.
     */
